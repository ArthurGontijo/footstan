...
#include "stanExports_negbinom_2.h"

RCPP_MODULE(stan_fit4negbinom_2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_negbinom_2")
