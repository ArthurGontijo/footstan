...
static constexpr std::array<const char*, 58> locations_array__ =
  ...
  " (in 'negbinom', line 30, column 2 to column 25)",
  " (in 'negbinom', line 31, column 2 to column 25)",
  ...
  " (in 'negbinom', line 52, column 4 to column 89)",
  " (in 'negbinom', line 53, column 4 to column 82)",
  " (in 'negbinom', line 54, column 4 to line 55, column 91)",
  " (in 'negbinom', line 51, column 22 to line 56, column 3)",
  " (in 'negbinom', line 51, column 2 to line 56, column 3)",
  " (in 'negbinom', line 35, column 4 to column 80)",
  " (in 'negbinom', line 36, column 4 to column 73)",
  ...
  " (in 'negbinom', line 40, column 2 to column 47)",
  " (in 'negbinom', line 41, column 2 to column 47)",
  ...
  " (in 'negbinom', line 18, column 2 to column 19)",
  " (in 'negbinom', line 19, column 2 to column 20)",
  " (in 'negbinom', line 20, column 2 to column 19)",
  " (in 'negbinom', line 21, column 2 to column 20)",
...
public:
  ~model_negbinom() {}
  model_negbinom(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_negbinom_namespace::model_negbinom";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_negbinom_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_negbinom_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      for (int g = 1; g <= ngames; ++g) {
        ...
        stan::model::assign(y1_pred,
          stan::math::neg_binomial_2_log_rng((((beta_0 + home) +
            stan::model::rvalue(att, "att",
              stan::model::index_uni(
        ...
        stan::model::assign(y2_pred,
          stan::math::neg_binomial_2_log_rng(((beta_0 +
            stan::model::rvalue(att, "att",
              stan::model::index_uni(
                stan::model::rvalue(a, "a", stan::model::index_uni(g))))) +
            stan::model::rvalue(def, "def",
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta_0", "home", "att", "def",
                "sd_att", "sd_def", "phi_home", "phi_away"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta_0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"home\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"att\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(nteams) + "},\"block\":\"parameters\"},{\"name\":\"def\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(nteams) + "},\"block\":\"parameters\"},{\"name\":\"sd_att\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sd_def\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"phi_home\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"phi_away\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"y1_pred\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(ngames) + ",\"element_type\":{\"name\":\"int\"}},\"block\":\"generated_quantities\"},{\"name\":\"y2_pred\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(ngames) + ",\"element_type\":{\"name\":\"int\"}},\"block\":\"generated_quantities\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(ngames) + "},\"block\":\"generated_quantities\"}]");
  }
