...
namespace model_negbinom_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'negbinom', line 24, column 2 to column 14)",
                                                      " (in 'negbinom', line 25, column 2 to column 12)",
                                                      " (in 'negbinom', line 26, column 2 to column 21)",
                                                      " (in 'negbinom', line 27, column 2 to column 21)",
                                                      " (in 'negbinom', line 28, column 2 to column 23)",
                                                      " (in 'negbinom', line 29, column 2 to column 23)",
                                                      " (in 'negbinom', line 30, column 2 to column 24)",
                                                      ...
                                                      " (in 'negbinom', line 34, column 2 to line 37, column 3)",
                                                      " (in 'negbinom', line 38, column 2 to column 40)",
                                                      " (in 'negbinom', line 39, column 2 to column 34)",
                                                      " (in 'negbinom', line 40, column 2 to column 44)",
                                                      " (in 'negbinom', line 41, column 2 to column 44)",
                                                      " (in 'negbinom', line 42, column 2 to column 41)",
                                                      " (in 'negbinom', line 43, column 2 to column 41)",
                                                      " (in 'negbinom', line 44, column 2 to column 31)",
                                                      " (in 'negbinom', line 45, column 2 to column 31)",
                                                      " (in 'negbinom', line 2, column 2 to column 22)",
                                                      " (in 'negbinom', line 3, column 2 to column 22)",
                                                      " (in 'negbinom', line 4, column 8 to column 14)",
                                                      " (in 'negbinom', line 4, column 2 to column 16)",
                                                      " (in 'negbinom', line 5, column 8 to column 14)",
                                                      " (in 'negbinom', line 5, column 2 to column 16)",
                                                      " (in 'negbinom', line 6, column 18 to column 24)",
                                                      " (in 'negbinom', line 6, column 2 to column 26)",
                                                      " (in 'negbinom', line 7, column 18 to column 24)",
                                                      " (in 'negbinom', line 7, column 2 to column 26)",
                                                      " (in 'negbinom', line 8, column 2 to column 17)",
                                                      " (in 'negbinom', line 9, column 2 to column 26)",
                                                      " (in 'negbinom', line 10, column 2 to column 15)",
                                                      " (in 'negbinom', line 11, column 2 to column 23)",
                                                      " (in 'negbinom', line 12, column 2 to column 14)",
                                                      " (in 'negbinom', line 13, column 2 to column 14)",
                                                      " (in 'negbinom', line 14, column 2 to column 17)",
                                                      " (in 'negbinom', line 15, column 2 to column 18)",
                                                      " (in 'negbinom', line 16, column 2 to column 17)",
                                                      " (in 'negbinom', line 17, column 2 to column 18)",
                                                      " (in 'negbinom', line 18, column 2 to column 18)",
                                                      " (in 'negbinom', line 19, column 2 to column 19)",
                                                      " (in 'negbinom', line 20, column 2 to column 18)",
                                                      " (in 'negbinom', line 21, column 2 to column 19)",
...
public:
  ...
  inline std::string model_name() const final { return "model_negbinom"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_negbinom(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_negbinom_namespace::model_negbinom";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_negbinom_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 7;
        phi_att = stan::math::lb_constrain(phi_att, 0, lp__);
      } else {
        current_statement__ = 7;
        phi_att = stan::math::lb_constrain(phi_att, 0);
      }
      local_scalar_t__ phi_def;
      phi_def = DUMMY_VAR__;
      ...
      if (jacobian__) {
        current_statement__ = 8;
        phi_def = stan::math::lb_constrain(phi_def, 0, lp__);
      } else {
        current_statement__ = 8;
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_negbinom_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      sd_def = stan::math::lb_constrain(sd_def, 0);
      double phi_att;
      phi_att = std::numeric_limits<double>::quiet_NaN();
      ...
      phi_att = stan::math::lb_constrain(phi_att, 0);
      double phi_def;
      phi_def = std::numeric_limits<double>::quiet_NaN();
      ...
      vars__.emplace_back(phi_att);
      vars__.emplace_back(phi_def);
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      double phi_att_free__;
      phi_att_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 7;
      phi_att_free__ = stan::math::lb_free(phi_att, 0);
      double phi_def;
      phi_def = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 8;
      phi_def = context__.vals_r("phi_def")[(1 - 1)];
      double phi_def_free__;
      phi_def_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 8;
      phi_def_free__ = stan::math::lb_free(phi_def, 0);
      vars__.emplace_back(beta_0);
      vars__.emplace_back(home);
      for (int sym1__ = 1; sym1__ <= nteams; ++sym1__) {
        vars__.emplace_back(att[(sym1__ - 1)]);}
      ...
      vars__.emplace_back(phi_att_free__);
      vars__.emplace_back(phi_def_free__);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
...
using stan_model = model_negbinom_namespace::model_negbinom;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_negbinom_namespace::profiles__;
}
#endif
#endif
